...
class DCGAN(nn.Module):
    def __init__(self, in_channels, out_channels, nker=64, norm="bnrom"):
...
class Discriminator(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, nker, norm="bnorm"):
        super(Discriminator, self).__init__()

        self.enc1 = CBR2d(in_channels, 1 * nker, kernel_size=4, stride=2, padding=1, norm=norm, relu=0.2, bias=False)
